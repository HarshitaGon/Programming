...
class Test
{
    public static void main(String[] args)
    {
        ...
        ref_first_node.ref_previous_node = null;
	    ref_first_node.ref_next_node = ref_second_node;

	    ref_second_node.ref_previous_node = ref_first_node;
	    ref_second_node.ref_next_node = ref_third_node;

        ref_third_node.ref_previous_node = ref_second_node;
	    ref_third_node.ref_next_node = ref_fourth_node;

        ref_fourth_node.ref_previous_node = ref_third_node;
	    ref_fourth_node.ref_next_node = ref_fifth_node;

        ref_fifth_node.ref_previous_node = ref_fourth_node;
        ...
        ref_current_node = ref_fifth_node;
